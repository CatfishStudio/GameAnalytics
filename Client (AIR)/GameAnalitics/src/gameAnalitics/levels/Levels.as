package gameAnalitics.levels 
{
	...
	import gameAnalitics.levels.LevelsDiagramUserID;
	import gameAnalitics.levels.LevelsDiagramDate;
	
	/**
	 * ...
	 * @author Somov Evgeniy
	 */
	public class Levels extends NativeWindowInitOptions 
	{
		private var _newWindow:NativeWindow;
		
		private var _diagramUserID:LevelsDiagramUserID;
		private var _diagramDate:LevelsDiagramDate;
		...
		{
			if (_newWindow.stage.getChildByName("LevelsDiagramUserID") != null) _newWindow.stage.removeChild(_diagramUserID);
			if (_newWindow.stage.getChildByName("LevelsDiagramDate") != null) _newWindow.stage.removeChild(_diagramDate);
			
			if (e.currentTarget.name == "USER_ID")
			{
				_diagramUserID = new LevelsDiagramUserID(_textBox2.text);
				_diagramUserID.name = "LevelsDiagramUserID";
				_diagramUserID.x = 5;
			...
			{
				_diagramDate = new LevelsDiagramDate(_comboBox3.selectedItem.data, _textBox3.text);
				_diagramDate.name = "LevelsDiagramDate";
				_diagramDate.x = 5;
				_diagramDate.y = 100;
