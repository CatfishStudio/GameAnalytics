package gameAnalitics.errors 
{
	 ...
	 */
	public class Errors extends NativeWindowInitOptions 
	{
		private var _newWindow:NativeWindow;
		
		private var _diagramUserID:ErrorsDiagramUserID;
		private var _diagramDate:ErrorsDiagramDate;
		...
		{
			if (_newWindow.stage.getChildByName("ErrorsDiagramUserID") != null) _newWindow.stage.removeChild(_diagramUserID);
			if (_newWindow.stage.getChildByName("ErrorsDiagramDate") != null) _newWindow.stage.removeChild(_diagramDate);
			
			if (e.currentTarget.name == "USER_ID")
			{
				_diagramUserID = new ErrorsDiagramUserID(_textBox2.text);
				_diagramUserID.name = "ErrorsDiagramUserID";
				_diagramUserID.x = 5;
			...
			{
				_diagramDate = new ErrorsDiagramDate(_comboBox3.selectedItem.data, _textBox3.text);
				_diagramDate.name = "ErrorsDiagramDate";
				_diagramDate.x = 5;
				_diagramDate.y = 100;
