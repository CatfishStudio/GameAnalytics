package gameAnalitics.retention 
{
	 ...
	 */
	public class Retention extends NativeWindowInitOptions 
	{
		private var _newWindow:NativeWindow;
		
		private var _diagramUserID:RetentionDiagramUserID;
		private var _diagramDate:RetentionDiagramDate;
		...
		{
			if (_newWindow.stage.getChildByName("RetentionDiagramUserID") != null) _newWindow.stage.removeChild(_diagramUserID);
			if (_newWindow.stage.getChildByName("RetentionDiagramDate") != null) _newWindow.stage.removeChild(_diagramDate);
			
			if (e.currentTarget.name == "USER_ID")
			{
				_diagramUserID = new RetentionDiagramUserID(_textBox2.text);
				_diagramUserID.name = "RetentionDiagramUserID";
				_diagramUserID.x = 5;
			...
			{
				_diagramDate = new RetentionDiagramDate(_comboBox3.selectedItem.data, _textBox3.text);
				_diagramDate.name = "RetentionDiagramDate";
				_diagramDate.x = 5;
				_diagramDate.y = 100;
