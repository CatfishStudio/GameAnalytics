package gameAnalitics.boosters 
{
	...
	import gameAnalitics.boosters.BoostersDiagramUserID;
	import gameAnalitics.boosters.BoostersDiagramDate;
	import gameAnalitics.boosters.BoostersDiagramName;
	
	/**
	 * ...
	 * @author Somov Evgeniy
	 */
	public class Boosters extends NativeWindowInitOptions 
	{
		private var _newWindow:NativeWindow;
		
		private var _diagramUserID:BoostersDiagramUserID;
		private var _diagramDate:BoostersDiagramDate;
		private var _diagramName:BoostersDiagramName;
		...
		private function showForm():void
		{
			...
			//-----------------------------------
			_label4.text = "Наименование:"; 
			_label4.x = 325; _label4.y = 30; _label4.width = 500; _label4.height = 100;
		...
		{
			if (_newWindow.stage.getChildByName("BoostersDiagramUserID") != null) _newWindow.stage.removeChild(_diagramUserID);
			if (_newWindow.stage.getChildByName("BoostersDiagramDate") != null) _newWindow.stage.removeChild(_diagramDate);
			if (_newWindow.stage.getChildByName("BoostersDiagramName") != null) _newWindow.stage.removeChild(_diagramName);
			
			if (e.currentTarget.name == "USER_ID")
			{
				_diagramUserID = new BoostersDiagramUserID(_textBox2.text);
				_diagramUserID.name = "BoostersDiagramUserID";
				_diagramUserID.x = 5;
			...
			{
				_diagramDate = new BoostersDiagramDate(_comboBox3.selectedItem.data, _textBox3.text);
				_diagramDate.name = "BoostersDiagramDate";
				_diagramDate.x = 5;
				_diagramDate.y = 100;
			...
			{
				_diagramName = new BoostersDiagramName(_textBox4.text);
				_diagramName.name = "BoostersDiagramName";
				_diagramName.x = 5;
				_diagramName.y = 100;
