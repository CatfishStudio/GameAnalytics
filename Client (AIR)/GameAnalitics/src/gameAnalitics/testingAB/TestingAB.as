package gameAnalitics.testingAB 
{
	 ...
	 */
	public class TestingAB extends NativeWindowInitOptions 
	{
		private var _newWindow:NativeWindow;
		
		private var _diagramUserID:TestingABDiagramUserID;
		private var _diagramDate:TestingABDiagramDate;
		private var _diagramName:TestingABDiagramName;
		...
		private function showForm():void
		{
			...
			//-----------------------------------
			_label4.text = "Запись:"; 
			_label4.x = 360; _label4.y = 30; _label4.width = 500; _label4.height = 100;
		...
		{
			if (_newWindow.stage.getChildByName("TestingABDiagramUserID") != null) _newWindow.stage.removeChild(_diagramUserID);
			if (_newWindow.stage.getChildByName("TestingABDiagramDate") != null) _newWindow.stage.removeChild(_diagramDate);
			if (_newWindow.stage.getChildByName("TestingABDiagramName") != null) _newWindow.stage.removeChild(_diagramName);
			
			if (e.currentTarget.name == "USER_ID")
			{
				_diagramUserID = new TestingABDiagramUserID(_textBox2.text);
				_diagramUserID.name = "TestingABDiagramUserID";
				_diagramUserID.x = 5;
			...
			{
				_diagramDate = new TestingABDiagramDate(_comboBox3.selectedItem.data, _textBox3.text);
				_diagramDate.name = "TestingABDiagramDate";
				_diagramDate.x = 5;
				_diagramDate.y = 100;
			...
			{
				_diagramName = new TestingABDiagramName(_textBox4.text);
				_diagramName.name = "TestingABDiagramName";
				_diagramName.x = 5;
				_diagramName.y = 100;
